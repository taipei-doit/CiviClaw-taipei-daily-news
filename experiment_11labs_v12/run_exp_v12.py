...
WORK_DIR = Path.home() / "tw-gov-video" / "experiment_11labs_v12"
...
def main():
    slides = [
        ...
        },
        {
            "type": "content",
            "title": "東京都副知事が台北市を訪問",
            "script": "東京都の宮坂学副知事が台北市を訪れ、蒋万安市長と会談し、両市の代表は、デジタルトランスフォーメーション（DX）とスタートアップ支援の分野で協力を強化することで一致しました。",
            "tts": "東京都の宮坂学副知事が台北市を訪れ、蒋万安市長と会談し、両市の代表は、デジタルトランスフォーメーション（DX）とスタートアップ支援の分野で協力を強化することで一致しました。",
        ...
        },
        {
            ...
            "script": "東京都・高円寺の代表団が、松山慈祐宮が主催する「松山文化祭」に参加し、会場で名物の阿波おどりを披露しました。蒋市長は、代表団が日台の文化交流の架け橋となっているとたたえました。",
            "tts": "東京都・高円寺の代表団が、松山慈祐宮が主催する「松山文化祭」に参加し、会場で名物の阿波おどりを披露しました。蒋市長は、代表団が日台の文化交流の架け橋となっているとたたえました。",
        ...
        },
        {
            ...
            "script": "東京都の小池百合子知事が台北市を訪問した際、蒋市長は、防災からスポーツイベントに至るまで多岐にわたる分野で、双方の交流が一層深まっていることを確認しました。",
            "tts": "東京都の小池百合子知事が台北市を訪問した際、蒋市長は、防災からスポーツイベントに至るまで多岐にわたる分野で、双方の交流が一層深まっていることを確認しました。",
    ...
    with sync_playwright() as p:
        ...
        concat_file = WORK_DIR / f"v12_concat.txt"
        concat_file.write_text("\n".join(clips))
        
        final_video = WORK_DIR / f"final_v12_ja.mp4"
