...
def translate_to_jp(text, is_title=False):
    ...
    url = f"https://us-central1-aiplatform.googleapis.com/v1/projects/{PROJECT_ID}/locations/us-central1/publishers/google/models/gemini-3.1-flash-preview:generateContent"
...
def main():
    ...
    print("Translating articles to Japanese and generating English subtitles...")
    jp_items = []
    ...
    jp_items.append({
        ...
        "en_sub": "Taipei City News. This video is automatically generated by AI."
    })
    ...
    for idx, item in enumerate(items):
        ...
        en_sub = translate_to_en(item.get("script", ""))
    ...
    jp_items.append({
        ...
        "en_sub": "That's all for today's Taipei City News. Thank you for watching, and see you tomorrow!"
    })
